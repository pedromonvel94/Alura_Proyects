...
function clickButtonPrompt(){
    let ciudadBrasil = prompt("Dime una ciuda de brasil: ");
...
function clickButtonAddition(){
    let numA = parseInt(prompt('Dime el primer numero: '));
    let numB = parseInt(prompt('Dime el segundo numero: '));
    let resultadoSuma = numA + numB; 

    alert(`El resultado de la suma entre ${numA} y ${numB} es: ${resultadoSuma}`);
}